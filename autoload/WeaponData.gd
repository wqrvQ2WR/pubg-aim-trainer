...
const WEAPONS := {
	...
	"m16a4": {"name": "M16A4", "category": "AR", "damage": 43, "rpm": 750, "magazine": 30,
	...
	"groza": {"name": "Groza", "category": "AR", "damage": 49, "rpm": 650, "magazine": 30,
		"fire_modes": ["single", "auto"],
	...
	"auga3": {"name": "AUG A3", "category": "AR", "damage": 43, "rpm": 650, "magazine": 30,
		"fire_modes": ["single", "auto"],
	...
	"berylm762": {"name": "베릴 M762", "category": "AR", "damage": 47, "rpm": 660, "magazine": 30,
		"fire_modes": ["single", "auto"],
		"recoil": {"vert_base": 1.0, "vert_growth": 0.1, "vert_cap": 2.7, "horiz_amp": 0.6, "horiz_bias": -0.35, "horiz_growth": 0.11, "kick_first": 1.3, "sustained": true}},
	"qbz95": {"name": "QBZ95", "category": "AR", "damage": 41, "rpm": 750, "magazine": 30,
	...
	"g36c": {"name": "G36C", "category": "AR", "damage": 43, "rpm": 700, "magazine": 30,
		"fire_modes": ["single", "auto"],
	...
	"k2": {"name": "K2", "category": "AR", "damage": 43, "rpm": 620, "magazine": 30,
		"fire_modes": ["single", "burst", "auto"],
	...
	"mk47": {"name": "Mk47 Mutant", "category": "AR", "damage": 49, "rpm": 500, "magazine": 20,
		"fire_modes": ["single", "burst"],
	...
	"famas": {"name": "FAMAS", "category": "AR", "damage": 41, "rpm": 900, "magazine": 25,
		"fire_modes": ["single", "burst"],
	...
	# ---------------- DMR ----------------
	"sks": {"name": "SKS", "category": "DMR", "damage": 58, "rpm": 300, "magazine": 10,
		"fire_modes": ["single"],
	...
	"mini14": {"name": "Mini14", "category": "DMR", "damage": 46, "rpm": 300, "magazine": 20,
		"fire_modes": ["single"],
	...
	"slr": {"name": "SLR", "category": "DMR", "damage": 58, "rpm": 300, "magazine": 10,
		"fire_modes": ["single"],
	...
	"mk14": {"name": "Mk14 EBR", "category": "DMR", "damage": 61, "rpm": 450, "magazine": 10,
		"fire_modes": ["single", "auto"],
	...
	"vss": {"name": "VSS", "category": "DMR", "damage": 41, "rpm": 300, "magazine": 10,
		"fire_modes": ["single", "auto"],
	...
	"qbu": {"name": "QBU", "category": "DMR", "damage": 51, "rpm": 300, "magazine": 10,
		"fire_modes": ["single"],
	...
	"svd": {"name": "드라구노프 (SVD)", "category": "DMR", "damage": 58, "rpm": 300, "magazine": 10,
		"fire_modes": ["single"],
		"recoil": {"vert_base": 1.6, "vert_growth": 0.0, "vert_cap": 1.0, "horiz_amp": 0.5, "horiz_bias": -0.2, "horiz_growth": 0.0, "kick_first": 1.6, "sustained": false}},
	"mk12": {"name": "Mk12", "category": "DMR", "damage": 49, "rpm": 300, "magazine": 10,
		"fire_modes": ["single"],
	...
	# ---------------- SMG ----------------
	"ump45": {"name": "UMP45", "category": "SMG", "damage": 39, "rpm": 500, "magazine": 25,
		"fire_modes": ["single", "auto"],
	...
	"vector": {"name": "Vector", "category": "SMG", "damage": 31, "rpm": 1100, "magazine": 13,
		"fire_modes": ["single", "auto"],
	...
	"uzi": {"name": "Micro UZI", "category": "SMG", "damage": 26, "rpm": 1200, "magazine": 25,
		"fire_modes": ["auto"],
	...
	"tommygun": {"name": "톰슨 (Tommy Gun)", "category": "SMG", "damage": 40, "rpm": 700, "magazine": 30,
		"fire_modes": ["single", "auto"],
	...
	"bizon": {"name": "PP-19 비존", "category": "SMG", "damage": 35, "rpm": 700, "magazine": 53,
		"fire_modes": ["single", "auto"],
	...
	"p90": {"name": "P90", "category": "SMG", "damage": 32, "rpm": 700, "magazine": 50,
		"fire_modes": ["single", "auto"],
	...
	"mp5k": {"name": "MP5K", "category": "SMG", "damage": 33, "rpm": 800, "magazine": 30,
		"fire_modes": ["single", "burst", "auto"],
	...
	# ---------------- LMG ----------------
	"m249": {"name": "M249", "category": "LMG", "damage": 45, "rpm": 650, "magazine": 100,
		"fire_modes": ["auto"],
	...
	"dp28": {"name": "DP-28", "category": "LMG", "damage": 47, "rpm": 500, "magazine": 47,
		"fire_modes": ["auto"],
	...
	"mg3": {"name": "MG3", "category": "LMG", "damage": 43, "rpm": 1150, "magazine": 75,
		"fire_modes": ["auto"],
	...
	# ---------------- 저격소총 (SR, 볼트/레버액션) ----------------
	"kar98k": {"name": "Kar98k", "category": "SR", "damage": 61, "rpm": 100, "magazine": 5,
		"fire_modes": ["single"],
	...
	"m24": {"name": "M24", "category": "SR", "damage": 79, "rpm": 100, "magazine": 5,
		"fire_modes": ["single"],
	...
	"awm": {"name": "AWM", "category": "SR", "damage": 105, "rpm": 100, "magazine": 5,
		"fire_modes": ["single"],
	...
	"win94": {"name": "Win94", "category": "SR", "damage": 55, "rpm": 150, "magazine": 8,
		"fire_modes": ["single"],
	...
	"amr": {"name": "AMR (Lynx)", "category": "SR", "damage": 145, "rpm": 60, "magazine": 5,
		"fire_modes": ["single"],
	...
	# ---------------- 권총 (Pistol) ----------------
	"p92": {"name": "P92", "category": "PISTOL", "damage": 33, "rpm": 350, "magazine": 15,
		"fire_modes": ["single"],
	...
	"p1911": {"name": "P1911", "category": "PISTOL", "damage": 34, "rpm": 300, "magazine": 7,
		"fire_modes": ["single"],
	...
	"r45": {"name": "R45 (Deagle)", "category": "PISTOL", "damage": 44, "rpm": 250, "magazine": 7,
		"fire_modes": ["single"],
	...
	"skorpion": {"name": "스콜피온", "category": "PISTOL", "damage": 22, "rpm": 1200, "magazine": 20,
		"fire_modes": ["single", "auto"],
	...
	"p18c": {"name": "P18C", "category": "PISTOL", "damage": 23, "rpm": 900, "magazine": 17,
		"fire_modes": ["single", "auto"],
	...
	# ---------------- 샷건 (Shotgun) ----------------
	"s12k": {"name": "S12K", "category": "SHOTGUN", "damage": 22, "rpm": 300, "magazine": 5,
		"fire_modes": ["single", "auto"],
	...
	"s686": {"name": "S686", "category": "SHOTGUN", "damage": 24, "rpm": 150, "magazine": 2,
		"fire_modes": ["single"],
	...
	"dbs": {"name": "DBS", "category": "SHOTGUN", "damage": 22, "rpm": 200, "magazine": 7,
		"fire_modes": ["single"],
