...
const WEAPONS := {
	# ---------------- 돌격소총 (AR) ----------------
	"akm": {"name": "AKM", "category": "AR", "damage": 47, "rpm": 600, "magazine": 30,
	...
	"m416": {"name": "M416", "category": "AR", "damage": 40, "rpm": 700, "magazine": 30,
		"fire_modes": ["single", "auto"],
	...
	"scarl": {"name": "SCAR-L", "category": "AR", "damage": 42, "rpm": 625, "magazine": 30,
		"fire_modes": ["single", "auto"],
	...
	"groza": {"name": "Groza", "category": "AR", "damage": 47, "rpm": 750, "magazine": 30,
		"fire_modes": ["single", "auto"],
	...
	"auga3": {"name": "AUG A3", "category": "AR", "damage": 40, "rpm": 650, "magazine": 30,
		"fire_modes": ["single", "auto"],
	...
	"berylm762": {"name": "베릴 M762", "category": "AR", "damage": 44, "rpm": 700, "magazine": 30,
		"fire_modes": ["single", "auto"],
	...
	"qbz95": {"name": "QBZ95", "category": "AR", "damage": 42, "rpm": 750, "magazine": 30,
	...
	"k2": {"name": "K2", "category": "AR", "damage": 41, "rpm": 620, "magazine": 30,
		"fire_modes": ["single", "burst", "auto"],
	...
	"mk47": {"name": "Mk47 Mutant", "category": "AR", "damage": 49, "rpm": 600, "magazine": 20,
		"fire_modes": ["single", "burst"],
	...
	"famas": {"name": "FAMAS", "category": "AR", "damage": 39, "rpm": 1000, "magazine": 25,
		"fire_modes": ["single", "burst"],
	...
	# ---------------- DMR ----------------
	"sks": {"name": "SKS", "category": "DMR", "damage": 53, "rpm": 600, "magazine": 10,
		"fire_modes": ["single"],
	...
	"mini14": {"name": "Mini14", "category": "DMR", "damage": 42, "rpm": 600, "magazine": 20,
		"fire_modes": ["single"],
	...
	"slr": {"name": "SLR", "category": "DMR", "damage": 56, "rpm": 600, "magazine": 10,
		"fire_modes": ["single"],
	...
	"mk14": {"name": "Mk14 EBR", "category": "DMR", "damage": 61, "rpm": 667, "magazine": 10,
		"fire_modes": ["single", "auto"],
	...
	"vss": {"name": "VSS", "category": "DMR", "damage": 45, "rpm": 700, "magazine": 10,
		"fire_modes": ["single", "auto"],
	...
	"qbu": {"name": "QBU", "category": "DMR", "damage": 42, "rpm": 600, "magazine": 10,
		"fire_modes": ["single"],
	...
	"svd": {"name": "드라구노프 (SVD)", "category": "DMR", "damage": 53, "rpm": 600, "magazine": 10,
		"fire_modes": ["single"],
		"recoil": {"vert_base": 1.6, "vert_growth": 0.0, "vert_cap": 1.0, "horiz_amp": 0.5, "horiz_bias": -0.2, "horiz_growth": 0.0, "kick_first": 1.6, "sustained": false}},
	"mk12": {"name": "Mk12", "category": "DMR", "damage": 43, "rpm": 600, "magazine": 10,
		"fire_modes": ["single"],
	...
	# ---------------- SMG ----------------
	"ump45": {"name": "UMP45", "category": "SMG", "damage": 41, "rpm": 674, "magazine": 25,
		"fire_modes": ["single", "auto"],
	...
	"vector": {"name": "Vector", "category": "SMG", "damage": 31, "rpm": 1090, "magazine": 13,
		"fire_modes": ["single", "auto"],
	...
	"tommygun": {"name": "톰슨 (Tommy Gun)", "category": "SMG", "damage": 40, "rpm": 750, "magazine": 30,
		"fire_modes": ["single", "auto"],
	...
	"mp5k": {"name": "MP5K", "category": "SMG", "damage": 32, "rpm": 850, "magazine": 30,
		"fire_modes": ["single", "burst", "auto"],
	...
	# ---------------- LMG ----------------
	"m249": {"name": "M249", "category": "LMG", "damage": 41, "rpm": 800, "magazine": 100,
		"fire_modes": ["auto"],
	...
	"m24": {"name": "M24", "category": "SR", "damage": 75, "rpm": 33, "magazine": 5,
		"fire_modes": ["single"],
	...
	"awm": {"name": "AWM", "category": "SR", "damage": 105, "rpm": 32, "magazine": 5,
		"fire_modes": ["single"],
	...
	# ---------------- 권총 (Pistol) ----------------
	"p92": {"name": "P92", "category": "PISTOL", "damage": 34, "rpm": 350, "magazine": 15,
		"fire_modes": ["single"],
	...
	"p1911": {"name": "P1911", "category": "PISTOL", "damage": 42, "rpm": 300, "magazine": 7,
		"fire_modes": ["single"],
	...
	"r45": {"name": "R45 (Deagle)", "category": "PISTOL", "damage": 65, "rpm": 240, "magazine": 7,
		"fire_modes": ["single"],
	...
	"p18c": {"name": "P18C", "category": "PISTOL", "damage": 23, "rpm": 1000, "magazine": 17,
		"fire_modes": ["single", "auto"],
	...
	"dbs": {"name": "DBS", "category": "SHOTGUN", "damage": 26, "rpm": 200, "magazine": 7,
		"fire_modes": ["single"],
